...
#sudo -u docker grep -q "for f in ~nano /scripts/*.sh; do source \$f; done" /home/docker/.ashrc || sudo -u docker echo "for f in ~/scripts/*.sh; do source \$f; done" >> /home/docker/.ashrc
